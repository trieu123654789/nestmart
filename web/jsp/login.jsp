                ...
                <div class="form-container">
                    ...
                    <form action="login.htm" method="post">
                        ...
                        <div class="form-row wrap-btn">
                            ...
                            <p><a href="forgotPassword.htm" class="link-to-help">Forgot your password?</a></p>
                            <p><a href="signup.htm" class="link-to-help">Don't have an account? Register</a></p>
                        </div>
                    </form>
                </div>
            </div>
