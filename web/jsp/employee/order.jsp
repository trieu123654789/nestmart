                ...
                <main class="content">
                    <div class="container mt-4">
                        <div class="search-container">
                            <form action="${pageContext.request.contextPath}/employee/order.htm" method="get" class="search-form">
                        ...
                        <c:if test="${not empty keyword}">
                            <c:choose>
                                <c:when test="${not empty listOrder}">
                                    ...
                                    <p>Found <b>${totalOrders}</b> results.</p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${order.shipperID == 0}">
                                                <a href="${pageContext.request.contextPath}/employee/assignShipper.htm?orderID=${order.orderID}" 
                                            ...
                                            <c:if test="${order.shipperID != 0 && order.orderStatus == 'Confirmed'}">
                                                <a href="${pageContext.request.contextPath}/employee/assignShipper.htm?orderID=${order.orderID}" class="btn btn-primary btn-sm">
                                                    Change Shipper
                                                </a>
                                            </c:if>

                                            <c:if test="${order.shipperID != 0 && order.orderStatus != 'Confirmed'}">
                                                <a href="${pageContext.request.contextPath}/employee/viewOrder.htm?orderID=${order.orderID}"  class="btn btn-primary btn-sm">
                                                    View Details
                                                </a>
                                            </c:if>
                                        </td>
