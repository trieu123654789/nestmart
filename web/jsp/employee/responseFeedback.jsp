                            ...
                            <form action="saveFeedbackResponse.htm" method="POST">
                                <div class="form-group">
                                    <div class="product-container">
                                        <img src="${pageContext.request.contextPath}/assets/admin/images/uploads/products/${feedbackdetails.productImage}" alt="alt" class="product-image"/>
                                        <div class="product-name"">
                                            <span>${feedbackdetails.productName}</span>
                                        </div>
                                    </div>
                                </div>
                                <hr/>
                                <div class="form-group">
                                    <div style="font-size: 18px;">
                                        <span>${feedbackdetails.customerName}</span>
                                    </div>
                                    <div style="color: #f5c518; font-size: 23px;">
                                        <c:forEach var="i" begin="1" end="${feedbackdetails.rating}">
                                            &#9733; 
                                        </c:forEach>
                                        <c:forEach var="i" begin="${feedbackdetails.rating + 1}" end="5">
                                            &#9734; 
                                        </c:forEach>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div style="font-size: 18px;">
                                        <span>${feedbackdetails.feedbackContent}</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <img src="${pageContext.request.contextPath}/assets/admin/images/uploads/products/${feedbackdetails.feedbackImage}" alt="alt" width="170px" height="auto"/>
                                </div>
                                <div class="form-group">
                                    <label for="feedbackDate">${feedbackdetails.formattedFeedbackDate}</label>
                                </div>
                                <div class="form-group">
                                    <label for="responseContent">Response Content:</label>
                                    <textarea class="form-control" name="responseContent" placeholder="Write your response here" required></textarea>
                                </div>
                                <input name="feedbackID" hidden="true" value="${feedbackdetails.feedbackID}" />
                                <input hidden="true" name="employeeID" value="2" />
