                ...
                <main class="content">
                    <div class="container mt-4">
                        <div class="container">
                            ...
                            <form id="voucherForm" action="${pageContext.request.contextPath}/employee/voucherCreate.htm" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="minOrderValue" name="minOrderValue" required>
                                </div>

                                <div class="form-group">
                                    <label for="maxDiscount">Max Discount:</label>
                                    <input type="number" step="0.01" class="form-control" id="maxDiscount" name="maxDiscount" required>
                                </div>
                                ...
                                <a href="${pageContext.request.contextPath}/vouchers.htm" class="btn btn-secondary">Cancel</a>
                            </form>
                        </div>
                    </div>
                </main>
