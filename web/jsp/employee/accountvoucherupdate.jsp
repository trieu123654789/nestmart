                ...
                <main class="content">
                    <div class="container mt-4">
                        <div class="container">
                            ...
                            <form id="accountVoucherForm" action="${pageContext.request.contextPath}/employee/accountVoucherUpdate.htm" method="post">
                                <input type="hidden" name="accountVoucherID" value="${accountVoucher.accountVoucherID}">

                                <div class="form-group">
                                    <label for="accountID">Account:</label>
                                    <select class="form-control" id="accountID" name="accountID" required>
                                        <c:forEach var="acc" items="${accounts}">
                                            <option value="${acc.AccountID}" ${acc.AccountID eq accountVoucher.accountID ? 'selected' : ''}>${acc.FullName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="voucherID" name="voucherID" required>
                                        <c:forEach var="v" items="${vouchers}">
                                            <option value="${v.VoucherID}" ${v.VoucherID eq accountVoucher.voucherID ? 'selected' : ''}>${v.Code}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="isUsed" name="isUsed" required>
                                        <option value="0" ${!accountVoucher.used ? 'selected' : ''}>Unused</option>
                                        <option value="1" ${accountVoucher.used ? 'selected' : ''}>Used</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="assignedDate" name="assignedDate"
                                           value="${accountVoucher.formattedAssignedDate}" required>    </div>

                                <div class="form-group">
                                    <label for="expiryDate">Expiry Date:</label>
                                    <input type="datetime-local" class="form-control" id="expiryDate" name="expiryDate"
                                           value="${accountVoucher.formattedExpiryDate}" required>    </div>

                                <button type="submit" class="btn btn-primary">Update Account Voucher</button>
                                <a href="${pageContext.request.contextPath}/employee/accountVouchers.htm" class="btn btn-secondary">Cancel</a>
                            </form>
