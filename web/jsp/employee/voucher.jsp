                ...
                <main class="content">
                    <div class="container mt-4">
                        <div class="search-container">
                            <form action="${pageContext.request.contextPath}/employee/vouchers.htm" method="get" class="search-form">
                                <input type="text" name="keyword" class="form-control search-input"
                                       placeholder="Search by voucher code" value="${keyword}">
                            ...
                            <div class="icon-container">
                                <button class="btn btn-add"
                                        onclick="window.location.href = '${pageContext.request.contextPath}/employee/voucherCreate.htm'">
                        ...
                        <c:if test="${not empty keyword}">
                            <c:choose>
                                <c:when test="${not empty listVoucher}">
                                    <p>Found <b>${totalVouchers}</b> results.</p>
                                </c:when>
                                <c:otherwise>
                        ...
                        <table class="table table-hover my-0" id="voucherTable">
                            <thead>
                                <tr>
                                    <th>Voucher ID</th>
                                    <th>Code</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-actions">
                                            <div class="btn-container">
                                                <a href="${pageContext.request.contextPath}/employee/voucherUpdate.htm?voucherID=${voucher.voucherID}"
                                                   class="btn btn-update" title="Edit">
                                                    <i data-feather="edit"></i>
                                                </a>
                                                <a href="${pageContext.request.contextPath}/employee/voucherDelete.htm?voucherID=${voucher.voucherID}"
