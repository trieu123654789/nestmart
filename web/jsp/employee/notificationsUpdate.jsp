                    ...
                    <div class="container mt-4">
                        <table class="table table-hover my-0" id="accountTable">
                            <div class="container">
                                ...
                                <form:form action="editNotification.htm" modelAttribute="editNotificationForm" method="POST">
                                    <div class="form-group">
                                        <form:input class="form-control" path="notificationID" hidden="true" value="${notification.notificationID}" />
                                        <label for="productName">Customer Name:</label>
                                        <form:input class="form-control" path="customerName" value="${notification.customerName}" readonly="true" />
                                    </div>
                                    <div class="form-group">
                                        <label for="quantity">Notification Type: </label>
                                        <form:input class="form-control" path="notificationType" type="text" value="${notification.notificationType}" />
                                    </div>
                                    <div class="form-group">
                                        <label for="quantity">Title: </label>
                                        <form:input class="form-control" path="title" type="text" value="${notification.title}" />
                                    </div>
                                    <div class="form-group">
                                        <label for="quantity">Message: </label>
                                        <form:input class="form-control" path="message" type="text" value="${notification.message}" />
                                    </div>
                                    <div class="form-group">
                                        <label for="quantity">Status: </label>
                                        <form:input class="form-control" path="status" type="text" value="${notification.status}" readonly="true"/>
                                    </div>
                                   
                                
                                    <form:button class="btn btn-primary" type="submit">Send Notification</form:button>
                                    <a href="${pageContext.request.contextPath}/employee/viewNotifications.htm" class="btn btn-secondary">Cancel</a>
                                </form:form>
                            </div>
                        </table>
                    </div>
