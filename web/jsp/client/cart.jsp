...
<head>
    ...
    <style>
        ...
        .sold-out .product-info, .sold-out .cart-image, .sold-out .product-name,
        .sold-out .unit-price, .sold-out .quantity-cell, .sold-out .item-total {
            opacity: 0.5;
        }
        .sold-out .quantity-controls button, .sold-out .quantity-controls input {
            pointer-events: none;
        }
        .sold-out::after {
            content: "SOLD OUT";
...
<body class="nestmart-body">
                                                ...
                                                <tr class="cart-row ${item.outOfStock ? 'sold-out' : ''}" 
                                                    ...
                                                    <td data-label="Product Image">
                                                        <img src="../assets/admin/images/uploads/products/${item.productImage}" 
                                                             alt="${item.productName}" class="cart-image" style="width: 80px;">
                                                    </td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td colspan="2" id="cart-total">
                                                    <strong><fmt:formatNumber value="${grandTotal}" 
                                                                            type="number" 
                                                                            minFractionDigits="2" 
                                                                            maxFractionDigits="2" 
    ...
    <script>
        // Fix decimal precision issues by working with cents
        ...
        function updateItemTotal(productId) {
            ...
            // Get price as number and fix precision
            const price = roundToTwoDecimals(parseFloat(priceEl.getAttribute('data-price')) || 0);
