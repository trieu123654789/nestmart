        ...
        <div class="container">
            ...
            <div class="top-bar left">
                <ul class="horizontal-menu">
                    <li>
                        <a href="#">
                            <i class="fa fa-envelope" aria-hidden="true"></i> Nestmart@company.com
                        </a>
                    </li>
                    <li>
                        <a href="#">Quality is not just our promise, it’s what makes our brand stand out.</a>                        </li>
                </ul>
            </div>
                    ...
                    <div class="nestmart-cart-info">
                        <div class="mobile-search">
                            ...
                            <div class="mobile-search-content">
                                <form action="product.htm" class="form-search" name="mobile-search" method="get">
