                ...
                <main class="content">
                    <div class="container mt-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="${pageContext.request.contextPath}/shipper/changePassword.htm" method="post" class="needs-validation" novalidate>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/shipper/account.htm" class="btn btn-secondary">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
