...
<html>
    <head>
        ...
        <title>NestMart - Inventory Create</title>
                    ...
                    <div class="container mt-4">
                        <table class="table table-hover my-0" id="accountTable">
                            <div class="container">
                                ...
                                <form:form action="addInventory.htm" modelAttribute="addInventoryForm" method="POST">
                                    <div class="form-group">
                                        <label for="productID">Product Name:</label>
                                        <form:select class="form-control" path="productID" id="product" required="true" >
                                            <form:option value="" label="Please select a product" />
                                            <form:options items="${productList}" itemValue="productID" itemLabel="productName" />
                                        </form:select>
                                    </div>
                                    <div class="form-group">
                                        <label for="quantity">Quantity:</label>
                                        <form:input class="form-control" path="quantity" type="number" min="1" />
