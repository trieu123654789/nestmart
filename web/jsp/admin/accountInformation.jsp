            ...
            <div class="main">
                ...
                <main class="content">
                    <div class="container mt-5">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/updateInformation.htm" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="text-center">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/accountInformation.htm" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
