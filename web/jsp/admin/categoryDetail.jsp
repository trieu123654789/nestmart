...
<html>
    <head>
        ...
        <title>NestMart - Category Details</title>
                    ...
                    <div class="container mt-4">
                        ...
                        <div class="search-container">
                            <form action="../admin/categoryDetail.htm" method="get" class="search-form">
                                ...
                                <input type="text" name="keyword" class="form-control search-input" placeholder="Search by product id, product name..." value="${keyword}">
                        ...
                        <c:if test="${not empty keyword}">
                            <c:choose>
                                <c:when test="${not empty listCategoryDetails}">
                                    <p>Found <b>${totalCategoryDetails}</b> results.</p>
                                </c:when>
                                <c:otherwise>
