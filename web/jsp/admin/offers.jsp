                    ...
                    <div class="container mt-4">
                        ...
                        <div class="search-container">
                            <form action="${pageContext.request.contextPath}/admin/offers.htm" method="get" class="search-form">
                                <input type="text" name="keyword" class="form-control search-input" placeholder="Search by product name, discount type, discount name of offer name" value="${keyword}">
                        ...
                        <c:if test="${not empty keyword}">
                            <c:choose>
                                <c:when test="${not empty listOffers}">
                                    <p>Found <b>${totalOffers}</b> results.</p>
                                </c:when>
                                <c:otherwise>
                        ...
                        <table class="table table-hover my-0" id="accountTable">
                            ...
                            <tbody>
                                <c:forEach var="offers" items="${listOffers}">
                                    <tr>
                                        ...
                                        <td>
                                <fmt:formatNumber value="${offers.unitPrice}" type="number" maxFractionDigits="0" groupingUsed="true" />$
                                </td>
                                ...
                                <td>
                                    <c:choose>
                                        ...
                                        <fmt:formatNumber value="${offers.discountValue}" type="number" maxFractionDigits="0" groupingUsed="true" />$
                                    </c:when>
                                ...
                                <td>
                                <fmt:formatNumber value="${offers.priceAfteroffer}" type="number" maxFractionDigits="0" groupingUsed="true" />$
                                </td>
                            ...
                            <c:if test="${empty listOffers}">
                                <tr>
                                    <td colspan="10">No offers found.</td>
                                </tr>
                            </c:if>
                            </tbody>
