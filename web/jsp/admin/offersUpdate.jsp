...
<html>
    <head>
        ...
        <title>NestMart - Offer Update</title>
                            ...
                            <table class="table table-hover my-0" id="accountTable">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="offerName" name="offerName" value="${offers.offerName}" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="offers.htm" class="btn btn-secondary">Cancel</a>
                                    </td>
                                </tr>
                            </table>
                        </form>
