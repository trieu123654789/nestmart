...
<link rel="shortcut icon" type="image/x-icon" href="../assets/client/images/NestMart_icon.png" />
        ...
        <title>NestMart - Edit Week Details</title>
            ...
            <div class="main">
                ...
                <main class="content">
                    <div class="container mt-5">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/admin/editWeekDetail.htm">
                            <input type="hidden" name="weekDetailID" value="${weekDetail.weekDetailID}" />
                            <input type="hidden" name="weekScheduleID" value="${weekDetail.weekScheduleID}" />
                                ...
                                <select name="employeeID" class="form-control" id="employeeID" required>
                                    ...
                                    <c:forEach var="employee" items="${accountsList}">
                                        <option value="${employee.accountID}" 
                                                <c:if test="${employee.accountID == weekDetail.employeeID}">selected</c:if>>
                            ...
                            <div class="form-group">
                                ...
                                <select name="dayID" class="form-control" id="dayID" required>
                                    <option value="">Select Day</option>
                                    <c:forEach var="day" items="${dayOfWeekList}">
                                        <option value="${day.dayID}" <c:if test="${day.dayID == weekDetail.dayID}">selected</c:if>>
                                            ${day.dayName}
                                        </option>
                                    </c:forEach>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="shiftID" class="form-control" id="shiftID" required>
                                    ...
                                    <c:forEach var="shift" items="${shiftList}">
                                        <option value="${shift.shiftID}" <c:if test="${shift.shiftID == weekDetail.shiftID}">selected</c:if>>
                                            ${shift.shiftName}
                                        </option>
                                    </c:forEach>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="overtimeHours" class="form-control" id="overtimeHours" 
                                       value="${weekDetail.overtimeHours}" min="0" required>
                            </div>

                            <button type="submit" class="btn btn-primary">Update Week Detail</button>
                            <a href="${pageContext.request.contextPath}/admin/scheduleDetails.htm?weekScheduleID=${weekDetail.weekScheduleID}" 
