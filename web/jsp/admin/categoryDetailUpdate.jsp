...
<html>
    <head>
        ...
        <title>NestMart - Category Detail Update</title>
                ...
                <main class="content">
                    <div class="container mt-4">
                        <table class="table table-hover my-0" id="accountTable">
                            <form action="../admin/categoryDetailUpdate.htm" method="post">
                                <c:if test="${not empty errorMessage}">
                                    <div class="alert alert-danger">${errorMessage}</div>
                                </c:if>

                                <!-- Hidden field to pass the categoryDetailID -->
                                <input type="hidden" name="categoryDetailID" value="${categoryDetails.categoryDetailID}" />
                                ...
                                <table class="table table-hover my-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" id="categoryID" name="categoryID" value="${categoryDetails.categoryName}" readonly />
                                            </td>
                                        </tr>
                                       <tr>
    ...
    <td>
        <select class="form-control" id="productID" name="productID">
            <option value="${categoryDetails.productID}" selected>${categoryDetails.productName}</option>
        </select>
    </td>
</tr>

                                        <tr>
                                            <td><label for="attributeName">Attribute Name:</label></td>
                                            <td><input type="text" class="form-control" id="attributeName" name="attributeName" value="${categoryDetails.attributeName}" required /></td>
                                        </tr>
                                        <tr>
                                            <td><label for="attributeValue">Attribute Value:</label></td>
                                            <td><input type="text" class="form-control" id="attributeValue" name="attributeValue" value="${categoryDetails.attributeValue}" required /></td>
                                        </tr>
                                    </tbody>
                                </table>

                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary">Update Category Detail</button>
                            ...
                            <script>
                                ...
                                function updateProducts() {
                                    ...
                                    var url = "../admin/categoryDetailUpdate.htm?categoryID=" + categoryID;
                                    ...
                                    fetch(url)
                                            ...
                                            .then(data => {
                                                ...
                                                var productSelect = doc.getElementById("productID");
                                                if (productSelect) {
                                                    document.getElementById("productID").innerHTML = productSelect.innerHTML;
                                                }
                                            })
