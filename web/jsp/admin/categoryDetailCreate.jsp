...
<html>
    <head>
        ...
        <title>NestMart - Category Details Create</title>
        ...
        <div class="wrapper">
            ...
            <div class="main">
                ...
                <main class="content">
                    ...
                    <form action="../admin/categoryDetailCreate.htm" method="post">
                        ...
                        <table class="table table-hover my-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" id="categoryID" name="categoryID" onchange="updateProducts()">
                                            <c:forEach var="category" items="${listCategories}">
                                                <option value="${category.categoryID}" 
                                                        <c:if test="${category.categoryID eq categoryID}">selected</c:if>>
                                ...
                                <tr>
                                    <td><label for="attributeCount">Number of Attributes:</label></td>
                                    <td>
                                        <select class="form-control" id="attributeCount" name="attributeCount" onchange="updateAttributeFields()">
                                            <c:forEach var="i" begin="1" end="10">
                                                <option value="${i}" ${i == attributeCount ? 'selected' : ''}>${i}</option>
                                            </c:forEach>
                                        </select>
                                    </td>
                                </tr>
                        ...
                        <div id="attributesContainer">
                            <c:forEach var="i" begin="1" end="${attributeCount}">
                                <div class="form-group">
                                    <label for="attributeName${i}">Attribute Name ${i}:</label>
                                    <input type="text" class="form-control" id="attributeName${i}" name="attributeName" value="" />

                                    <label for="attributeValue${i}">Attribute Value ${i}:</label>
                                    <input type="text" class="form-control" id="attributeValue${i}" name="attributeValue" value="" />
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Create Category Detail</button>
                            <a href="../admin/categoryDetail.htm" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
...
<script>
                                            ...
                                            function updateAttributeFields() {
                                                var count = document.getElementById("attributeCount").value;
                                                ...
                                                for (var i = 1; i <= count; i++) {
                                                    ...
                                                    labelName.setAttribute("for", "attributeName" + i);
                                                    labelName.innerText = "Attribute Name " + i + ":";

                                                    var inputName = document.createElement("input");
                                                    inputName.type = "text";
                                                    inputName.className = "form-control";
                                                    inputName.id = "attributeName" + i;
                                                    inputName.name = "attributeName";
                                                    inputName.required = true;

                                                    var labelValue = document.createElement("label");
                                                    labelValue.setAttribute("for", "attributeValue" + i);
                                                    labelValue.innerText = "Attribute Value " + i + ":";

                                                    var inputValue = document.createElement("input");
                                                    inputValue.type = "text";
                                                    inputValue.className = "form-control";
                                                    inputValue.id = "attributeValue" + i;
                                                    inputValue.name = "attributeValue";
                                            ...
                                            // Initialize attribute fields on page load
                                            ...
                                            function updateProducts() {
                                                ...
                                                window.location.href = "${pageContext.request.contextPath}/admin/categoryDetailCreate.htm?categoryID=" + categoryId;
                                            }
</script>
