...
public class ClientChatController {
    ...
    // Handle sending new message from client
    ...
    public String checkSession(HttpSession session) {
        Integer accountId = (Integer) session.getAttribute("accountId");
        if (accountId != null) {
            return "<response><status>loggedIn</status><accountId>" + accountId + "</accountId></response>";
        } else {
            return "<response><status>notLoggedIn</status></response>";
        }
    }
}
