...
public class Salary {
    ...
    public Salary(int salaryID, int accountID, Date salaryPaymentDate, BigDecimal totalHours, BigDecimal hourlyRate, BigDecimal totalSalary, int weekScheduleID, int shiftID, String status) {
