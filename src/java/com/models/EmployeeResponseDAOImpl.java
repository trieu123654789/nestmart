...
public class EmployeeResponseDAOImpl implements EmployeeResponseDAO {
    ...
    // Inserts a new employee response into the database
    @Override
    ...
    // Retrieves all employee responses by a specific feedback ID
    @Override
    ...
    // Maps a ResultSet row to an EmployeeResponse object
