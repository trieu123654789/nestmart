...
public class SalesReportDAOImpl implements SalesReportDAO {
    ...
    // Maps SQL result set to ProductSalesReport object
    private static final RowMapper<ProductSalesReport> REPORT_ROW_MAPPER = new RowMapper<ProductSalesReport>() {
        ...
        public ProductSalesReport mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            if (orderTimestamp != null) {
                report.setOrderDate(orderTimestamp);
            }
    ...
    // Retrieves all sales reports between two dates
    @Override
    ...
    // Retrieves sales report for a specific product with optional date filter
    @Override
    ...
    // Retrieves sales report for a specific product and customer
    @Override
    ...
    // Retrieves sales report for a specific customer
    @Override
    ...
    // Retrieves top selling products within date range
    @Override
    ...
    // Counts total orders in date range
    @Override
    ...
    // Counts total products sold in date range
    @Override
    ...
    // Returns count of orders by status within date range
    @Override
    ...
    // Retrieves sales report with pagination
    @Override
    ...
    // Counts total sales report rows for pagination
    @Override
